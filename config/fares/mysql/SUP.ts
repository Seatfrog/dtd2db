...
const supplement = new FixedWidthRecord(
  ...
  {
    "supplement_code": new TextField(2, 3, true),
    "end_date": new DateField(5, true),
    "start_date": new DateField(13, true),
    "quote_date": new DateField(21, true),
    "description": new TextField(29, 20, true),
    "short_desc": new TextField(49, 12, true),
    "suppl_type": new TextField(61, 3, true),
    "price": new IntField(64, 5, true, [" ", "*"]),
    "cpf_ticket_type": new TextField(69, 5, true),
    "min_group_size": new IntField(74, 1, true),
    "max_group_size": new IntField(75, 1, true),
    "per_leg_or_dir": new TextField(76, 1, true),
    "class_type": new TextField(77, 1, true),
    "capri_code": new TextField(78, 3, true),
    "sep_tkt_ind": new TextField(81, 1, true),
    "resvn_type": new TextField(82, 2, true),
