...
**Description:**  
Defines date ranges and day-of-week restrictions for specific train restrictions, allowing train restrictions to be applied only on certain days within certain date ranges.
